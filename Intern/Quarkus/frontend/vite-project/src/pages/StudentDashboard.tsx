...
// import {  Course, Enrolls, UpcomingLecture } from "../types";
...
//   const effectiveUserId = userId || "STU001"; // Fallback for testing

//   // Log userId for debugging
//   React.useEffect(() => {
//     console.log("StudentDashboard mounted with userId from route:", userId);
//     console.log("Effective userId:", effectiveUserId);
//     if (!userId) {
//       console.warn('No userId in route. Using fallback ID "STU001"');
//       toast.error("No student ID provided in URL. Using fallback.");
...
//       const response = await axios.get(`${API_URL}/api/student/${effectiveUserId}`);
...
//       const response = await axios.get(`${API_URL}/api/enroll/student/${effectiveUserId}`);
...
//       const response = await axios.get(`${API_URL}/api/attendance/student/${effectiveUserId}`);
...
//   // const { data: upcomingLectures, isLoading: upcomingLoading, error: upcomingError } = useQuery({
//   //   queryKey: ["upcomingLectures", effectiveUserId],
//   //   queryFn: async () => {
//   //     console.log(`Fetching upcoming lectures for userId: ${effectiveUserId}`);
//   //     const response = await axios.get(`${API_URL}/api/lecture/upcoming/${effectiveUserId}`);
//   //     console.log("Upcoming lectures:", response.data);
//   //     return response.data; // UpcomingLecture[]
//   //   },
//   // });
...
//       const response = await axios.get(`${API_URL}/api/student/${effectiveUserId}/progress`);
...
//             return course?.modules
//               ? course.modules.reduce(
//                   (sum: number, module: any) => sum + (module.numberOfCredits || 0),
//                   0
//                 )
//               : 0;
//           }) || [],
...
//   // const attendanceChartData = {
//   //   labels: attendanceData?.map((data: AttendanceData) => data.moduleName) || [],
//   //   datasets: [
//   //     {
//   //       label: "Attended Lectures",
//   //       data: attendanceData?.map((data: AttendanceData) => data.attendedLectures) || [],
//   //       backgroundColor: "rgba(75, 192, 192, 0.6)",
...
//   //     {
//   //       label: "Total Lectures",
//   //       data: attendanceData?.map((data: AttendanceData) => data.totalLectures) || [],
//   //       backgroundColor: "rgba(255, 99, 132, 0.6)",
...
//   // Check for errors
//   const hasError = studentError || enrollmentsError || coursesError || attendanceError  || progressError;
...
//       {studentLoading || enrollmentsLoading || coursesLoading || attendanceLoading  || progressLoading ? (
//         <p>Loading...</p>
//       ) : hasError ? (
...
//                     return (
//                       <li key={enroll.enrollmentId}>
//                         {course?.name || enroll.courseId} (Enrolled: {new Date(enroll.enrollmentDate).toLocaleDateString()})
//                       </li>
//                     );
//                   })}
//                 </ul>
...
//                   options={{
//                     plugins: {
//                       title: { display: true, text: "Lecture Attendance by Module" },
//                       legend: { position: "top" },
//                     },
//                     scales: {
//                       y: {
...
//                 <>
//                   <Progress
//                     value={(progressData.completedCredits / progressData.totalCredits) * 100}
//                   />
//                   <p className="mt-2">
